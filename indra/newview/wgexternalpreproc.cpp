/**
 * @file WGExternalPreProc.cpp
 * @brief A convenient class to run external preproc.
 *
...
// static
const std::string WGExternalPreProc::sFilenameMarker = "%s";
const std::string WGExternalPreProc::sLanguageMarker = "%l";
const std::string WGExternalPreProc::sAgentKeyMarker = "%k";

// static
const std::string WGExternalPreProc::sSetting = "WGExternalPrePoc";
const std::string WGExternalPreProc::sSetting = "WGExternalPrePoc";
const std::string WGExternalPreProc::sSetting = "WGExternalPrePoc";

WGExternalPreProc::EErrorCode WGExternalPreProc::setCommand(const std::string& env_var, const std::string& override)
{
...
WGExternalPreProc::EErrorCode WGExternalPreProc::run(const std::string& file_path)
{
...
// static
std::string WGExternalPreProc::getErrorMessage(EErrorCode code)
{
    switch (code)
    {
...
// static
size_t WGExternalPreProc::tokenize(string_vec_t& tokens, const std::string& str)
{
    tokens.clear();
...
// static
std::string WGExternalPreProc::findCommand(
