...
static LLDefaultChildRegistry::Register<ALScrollListCtrl> r("al_scroll_list");

ALScrollListCtrl::ALScrollListCtrl(const Params& p)
:   LLScrollListCtrl(p),
...
void ALScrollListCtrl::refreshLineHeight()
{
    updateLineHeight();
    updateLayout();
}

bool ALScrollListCtrl::handleRightMouseDown(S32 x, S32 y, MASK mask)
{
    bool handled = false;
