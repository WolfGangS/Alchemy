...
class ALPanelAreaSearchList;
class ALPanelAreaSearchFind;
class ALPanelAreaSearchFilter;
class ALPanelAreaSearchAdvanced;
class ALPanelAreaSearchOptions;
class ALScrollListCtrl;

struct ALObjectProperties
{
    LLUUID id;
    bool listed{ false };
    std::string name;
...
// --------------------------------------------------------------------
class ALAreaSearch : public LLFloater
{
    LOG_CLASS(ALAreaSearch);
public:
    ALAreaSearch(const LLSD &);
    virtual ~ALAreaSearch();
    ...
    std::map<LLUUID, ALObjectProperties> mObjectDetails;

    ALPanelAreaSearchAdvanced* getPanelAdvanced() { return mPanelAdvanced; }
    ALPanelAreaSearchList* getPanelList() { return mPanelList; }
...
private:
    ...
    void matchObject(ALObjectProperties& details, LLViewerObject* objectp);
    ...
    class ALParcelChangeObserver;
    friend class ALParcelChangeObserver;
    std::unique_ptr<ALParcelChangeObserver> mParcelChangedObserver;

    LLTabContainer* mTab{ nullptr };
    ALPanelAreaSearchList* mPanelList{ nullptr };
    ALPanelAreaSearchFind* mPanelFind{ nullptr };
    ALPanelAreaSearchFilter* mPanelFilter{ nullptr };
    ALPanelAreaSearchOptions* mPanelOptions{ nullptr };
    ALPanelAreaSearchAdvanced* mPanelAdvanced{ nullptr };
...
:   public LLPanel
{
    LOG_CLASS(ALPanelAreaSearchList);
    friend class ALAreaSearchMenu;
    friend class ALPanelAreaSearchOptions;

public:
    ALPanelAreaSearchList(ALAreaSearch* pointer);
    virtual ~ALPanelAreaSearchList();
    ...
    ALScrollListCtrl* getResultList() { return mResultList; }
...
private:
    void onDoubleClick();
    void onClickRefresh();
    void buyObject(ALObjectProperties& details, LLViewerObject* objectp);
    void sitOnObject(ALObjectProperties& details, LLViewerObject* objectp);
...
:   public LLPanel
{
    LOG_CLASS(ALPanelAreaSearchFind);
public:
    ALPanelAreaSearchFind(ALAreaSearch* pointer);
    virtual ~ALPanelAreaSearchFind() = default;
...
:   public LLPanel
{
    LOG_CLASS(ALPanelAreaSearchFilter);
public:
    ALPanelAreaSearchFilter(ALAreaSearch* pointer);
    virtual ~ALPanelAreaSearchFilter() = default;
...
:   public LLPanel
{
    LOG_CLASS(ALPanelAreaSearchOptions);
public:
    ALPanelAreaSearchOptions(ALAreaSearch* pointer);
    virtual ~ALPanelAreaSearchOptions() = default;
...
:   public LLPanel
{
    LOG_CLASS(ALPanelAreaSearchAdvanced);
public:
    ALPanelAreaSearchAdvanced() = default;
    virtual ~ALPanelAreaSearchAdvanced() = default;
