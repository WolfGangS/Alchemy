...
#ifndef WG_EXTERNALPREPROC_H
#define WG_EXTERNALPREPROC_H
...
private:
    ...
    static const std::string sLanguageMarker;
    static const std::string sAgentKeyMarker;
